...
import com.craemon.lasertag.item.custom.TestLaserBlasterItem;
...
public class ModItems {
    ...
    public static final Item RED_LASER_BLASTER = registerItem("redlaserblaster", new LaserBlasterItem(new Item.Settings()));

    //public static final Item GREEN_LASER_BLASTER = registerItem("greenlaserblaster", new TestLaserBlasterItem(new Item.Settings()));
